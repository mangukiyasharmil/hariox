...
const CreditAboutUsContent = () => (
  <div className="min-h-screen bg-white">
    <SEOHead
      title="About Credit Hariox | Best Loan Services in India"
      description="Learn about Credit Hariox, a reliable loan partner that helps you get an instant personal loan with an quick approval, low interest rates, and fast disbursal."
      keywords="About Finance Hariox, personal loan, loan services"
      canonicalUrl="https://credit.hariox.com/about"
    />
    <Header />
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <motion.div {...fadeUp} className="text-center mb-14 max-w-2xl mx-auto">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
              Why Choose <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Credit Hariox</span>
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
            {whyChooseItems.map((item, i) => (
              <motion.div
                ...
                className="bg-gray-50 rounded-xl p-5 text-center border border-gray-100 hover:border-blue-300 hover:shadow-md transition-all group"
              >
                <div className="w-12 h-12 mx-auto mb-3 rounded-xl bg-blue-50 flex items-center justify-center group-hover:bg-blue-600 transition-colors">
...
const CreditAboutUs = () => (
  <PublicCompanyProvider slug="hariox">
    <CreditAboutUsContent />
  </PublicCompanyProvider>
);

export default CreditAboutUs;
