...
const services = [
  ...
  { icon: Building2, title: "Loan Against Property", description: "Leverage your property for high-value loans at competitive rates.", rate: "9.5%", maxAmount: "₹10 Crores", features: ["High Loan Value", "Long Tenure", "Lower Interest"] },
...
const CapitalServicesPageContent = () => {
  const [isModalOpen, setIsModalOpen] = useState(false);

  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="Loan Services | Fast Loan Approvals India"
        description="Explore all loan services offered by Capital Hariox. Personal, home, business, education loans and more with fast approvals."
        keywords="loan services, personal loan, home loan, business loan, capital hariox services"
        canonicalUrl="https://capital.hariox.com/services"
      />
      <CapitalHeader />
        ...
        <section className="relative bg-gradient-to-br from-gray-900 via-emerald-900 to-teal-900 py-20 lg:py-28 overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10 text-center">
            ...
            <motion.p {...fadeUp} transition={{ delay: 0.2 }} className="text-lg text-gray-300 max-w-2xl mx-auto">
              Fast loan approvals with minimal documentation. Choose from 8+ loan products.
            </motion.p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4 lg:px-8">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
              {services.map((service, i) => (
                ...
                >
                  <div className="w-12 h-12 rounded-xl bg-emerald-50 flex items-center justify-center mb-4 group-hover:bg-emerald-500 transition-colors">
                  ...
                  <div className="flex items-center gap-4 mb-4 text-sm">
                    <span className="text-emerald-600 font-bold">From {service.rate} p.a.</span>
        ...
        <section className="py-16 bg-gradient-to-r from-emerald-600 to-teal-600">
          <div className="container mx-auto px-4 text-center">
            <motion.div {...fadeUp}>
              ...
              <p className="text-emerald-100 mb-8 max-w-lg mx-auto">Our experts will help you find the perfect loan product based on your needs.</p>
              <Button size="lg" className="bg-white text-emerald-600 hover:bg-gray-50" onClick={() => setIsModalOpen(true)}>
...
const CapitalServicesPage = () => (
  <PublicCompanyProvider slug="capital">
    <CapitalServicesPageContent />
  </PublicCompanyProvider>
);

export default CapitalServicesPage;
