            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  By accessing and using the Capital Hariox website and services, you accept and 
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Capital Hariox is a loan facilitation platform that connects borrowers with 
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Capital Hariox may charge a processing fee for loan facilitation services. 
...
export default CapitalTermsOfService;
