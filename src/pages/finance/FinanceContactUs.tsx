...
const FinanceContactUsContent = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="Contact Finance Hariox for Loan Help & Support"
        description="Contact Finance Hariox for quick support. Our team is available via phone or email to assist with loan inquiries, applications, and other questions."
        keywords="Contact Us, Get in Touch, Call Us, Email Us, finance hariox, personal loan"
        canonicalUrl="https://finance.hariox.com/contact"
      />
      <FinanceHeader />

      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#0d1b2a] via-[#1a365d] to-[#2c5282] overflow-hidden pt-20">
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 -right-32 w-96 h-96 bg-[#c9a227]/10 rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 -left-32 w-96 h-96 bg-[#1a365d]/20 rounded-full blur-3xl" />
        </div>
        <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-[#c9a227]/20 text-[#c9a227] px-4 py-2 rounded-full text-sm font-medium mb-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    {item.href ? (
                      <a href={item.href} className="text-gray-900 font-semibold hover:text-[#1a365d] transition-colors">
                        {item.value}
                      </a>
                    ) : (
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-[#1a365d] to-[#0d1b2a] rounded-xl p-6 text-white"
            >
              <h3 className="text-lg font-bold mb-2">Need a Quick Loan?</h3>
              <p className="text-sm text-gray-300 mb-4">Apply now and get approval within 24 hours.</p>
              <Button variant="secondary" size="lg" className="w-full bg-[#c9a227] hover:bg-[#b8911f] text-white border-0" onClick={() => setIsModalOpen(true)}>
                Apply Now
              </Button>
            </motion.div>
          </div>
          ...
          >
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 md:p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-1" style={{ fontFamily: "'Georgia', serif" }}>Send us a Message</h2>
                  ...
                  <FormField control={form.control} name="terms" render={({ field }) => (
                    <FormItem className="flex items-start gap-3">
                      ...
                      <FormLabel className="text-sm leading-snug cursor-pointer font-normal">
                        I accept the <a href="/terms-conditions" className="text-[#1a365d] underline">Terms & Conditions</a> and <a href="/privacy-policy" className="text-[#1a365d] underline">Privacy Policy</a>
                      </FormLabel>
                      <FormMessage />
                    </FormItem>
                  )} />
                  <Button type="submit" size="lg" className="w-full md:w-auto bg-[#1a365d] hover:bg-[#0d1b2a] text-white" disabled={isSubmitting}>
...
const FinanceContactUs = () => (
  <PublicCompanyProvider slug="finance">
    <FinanceContactUsContent />
  </PublicCompanyProvider>
);

export default FinanceContactUs;
