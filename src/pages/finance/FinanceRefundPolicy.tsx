...
const FinanceRefundPolicy = () => {
  const backUrl = '/';

  return (
    <div className="min-h-screen bg-white">
      <SEOHead
        title="Finance Hariox Refund Policy – Customer Guidelines"
        description="Check Finance Hariox's Refund Policy to understand refund conditions, payment guidelines, and important details regarding our loan and finance services."
        keywords="Refund Policy"
        canonicalUrl="https://finance.hariox.com/refund-policy"
      />
      <FinanceHeader />
            ...
            <div className="prose prose-lg max-w-none text-gray-700">
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed">
                  At Finance Hariox, we strive to provide transparent and fair services to all 
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-600 leading-relaxed mb-4">
                  Finance Hariox charges a nominal processing fee (₹799 including GST) for loan facilitation services. 
...
export default FinanceRefundPolicy;
